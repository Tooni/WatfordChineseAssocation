...
export const HighstreetLightingArticle: FunctionComponent = () => (
  <>
    <Article>
      <Article.Text>
        To celebrate the Chinese New Year 2025 and the Watford Chinese Culture
        Show, local business companies, especially in the High Street, specially
        arranged two days of high street lighting ceremonies, which were held on
        29th January (the first day of the Lunar New Year) and 9th February
        respectively, starting at 3 p.m.
      </Article.Text>
      <Article.Text>
        The show included fantastic performances by Lijun Bi and other
        performers to celebrate the start of the Year of the Snake. This show
        was curated by Lijun Bi.
      </Article.Text>
      <Article.Text>
